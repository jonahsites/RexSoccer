    ...
    <section ref={containerRef} className="relative h-screen w-full flex items-start justify-center overflow-hidden">
      <div className="sticky top-0 h-screen w-full flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-white/10 to-transparent z-[5]" />
          <img 
            src={backgroundImage} 
            alt="Soccer Field"
          ...
          <motion.div style={{ y, opacity }}>
            <div className="absolute inset-0 z-[-1] opacity-30 pointer-events-none overflow-hidden">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2 w-[110%] h-[110%] -translate-x-5 -translate-y-5">
                <img src="/Screenshot 2026-04-25 at 10.18.38 AM.png" className="w-full h-full object-cover contrast-[1.1]" referrerPolicy="no-referrer" />
                ...
                <img src="https://lh3.googleusercontent.com/d/1etZ43OxAu9o0txlet_IVg5o2SBpjEl1I" className="w-full h-full object-cover contrast-[1.1]" referrerPolicy="no-referrer" />
                <img src="https://lh3.googleusercontent.com/d/1nDdhtbVYEKRYTPZhMk7KAtUj_CGVMgwx" className="w-full h-full object-cover contrast-[1.1]" referrerPolicy="no-referrer" />
                <img src="https://lh3.googleusercontent.com/d/1A7uH4tuMDmH07CD_Z7zY3Iwt91md92vU" className="w-full h-full object-cover contrast-[1.1]" referrerPolicy="no-referrer" />
                <img src="https://lh3.googleusercontent.com/d/1vhEBQOJfure9bxmb_HcjSN8Iy5xBeXwl" className="w-full h-full object-cover contrast-[1.1]" referrerPolicy="no-referrer" />
                <img src="https://lh3.googleusercontent.com/d/1l3xOIw56gIqJ3z0LRsq_vQyd-rkO7w-9" className="w-full h-full object-cover contrast-[1.1]" referrerPolicy="no-referrer" />
              </div>
            </div>
