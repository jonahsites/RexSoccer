...
export const Hero = ({
  backgroundImage = "https://lh3.googleusercontent.com/d/12zXZLM4fkxjrA7bKv083_aXjU5RgNyza",
...
Builder.registerComponent(Hero, {
  name: 'Hero',
  inputs: [
    { name: 'backgroundImage', type: 'file', defaultValue: "https://lh3.googleusercontent.com/d/12zXZLM4fkxjrA7bKv083_aXjU5RgNyza" },
