              ...
              {paragraphs.map((p, i) => {
                ...
                return (
                  <p
                    key={i}
                    className={cn(
                      p === "REX is where serious players train." ? "text-white text-4xl md:text-6xl font-black uppercase tracking-tighter mt-12 leading-[0.85]" : "text-white text-sm font-light"
                    )}
                  >
