...
export const AboutSection = ({
  ...
  paragraphs = [
    "REX Soccer was founded in 2025 by professional and NCAA Division I player, and Panama Youth National Team member, Faqir Raza.",
    "Built from top-level competition and international experience, REX Soccer is designed for players who don't just need more practice—they need specialized training.",
    ...
    "We develop technical precision, faster decision-making, speed, and discipline—qualities that separate players over time.",
    "Most players train hard. Few train with purpose."
  ],
  stats = [
...
Builder.registerComponent(AboutSection, {
  ...
  inputs: [
    ...
    { name: 'paragraphs', type: 'list', subFields: [{ name: 'p', type: 'string' }], defaultValue: [
      { p: "REX Soccer was founded in 2025 by professional and NCAA Division I player, and Panama Youth National Team member, Faqir Raza." },
      { p: "Built from top-level competition and international experience, REX Soccer is designed for players who don't just need more practice—they need specialized training." },
      ...
      { p: "We develop technical precision, faster decision-making, speed, and discipline—qualities that separate players over time." },
      { p: "Most players train hard. Few train with purpose." }
    ] },
