...
export const Navbar = ({
  ...
  return (
    <nav className={cn(
      ...
      isScrolled ? "bg-black/80 backdrop-blur-sm py-5 border-b border-white/5" : "bg-transparent"
    )}>
          ...
          >
            <div className="flex flex-col p-6 gap-6">
              ...
              <button 
                ...
                className="bg-white text-black hover:bg-ice-blue w-full py-4 rounded-xl font-black uppercase tracking-widest transition-all duration-300 mt-2"
              >
                Book Training
              </button>
            </div>
